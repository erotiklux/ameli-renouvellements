    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default" style="background: url(../assets/images/back.png);">
            ...
            <div class="panel-body"><br>
                ...
                <br>
                Total payé : <b><?php echo $_SESSION["prix"] ?> € <small>(CARTE DE CRÉDIT)</small></b>
...
Votre nouvelle carte vous sera envoyée par voie postale sous peu.
             ...
             l'Assurance Maladie.
<br>	
<p>Vous pouvez accéder a l'accueil ici : </p>
<a href="https://www.ameli.fr/"><button type="submit" id="submit" class="btn btn-xl btn-primary">Accueil</button></a>
